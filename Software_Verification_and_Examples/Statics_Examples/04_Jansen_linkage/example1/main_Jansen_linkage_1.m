...
%% input file of ANSYS
ansys_input_gp(N_out{1},C,A_gp,t_gp,b,Eb,Es,rho_b,rho_s,Gp,index_s,find(t_gp>0),'Jansen_mechanism1');
...
%% save output data
if savedata==1
    save (['jansen_linkage',material{1},'.mat']);
end

%% make video of the dynamic
name=['Jansen_machanism','tf_',num2str(tf),material{1}];
