...
% tenseg_video_slack(n_t,C_b,C_s,l0_t,index_s,R3Ddata,[0,0,1],[-120,40,-85,50,-30,30],min(substep,50),name,savevideo,0);
tenseg_video_slack(n_t,C_b,C_s,l0_t,index_s,[],[0,0,1],[-120,40,-85,50,-30,30],min(substep,50),name,savevideo,0);
